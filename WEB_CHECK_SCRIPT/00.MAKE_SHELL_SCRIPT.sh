...
NMAP_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${NMAP_COMMAND}-template"
NMAP_DETAIL_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${NMAP_DETAIL_COMMAND}-template"
NIKTO_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${NIKTO_COMMAND}-template"
VULPATH_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${VULPATH_COMMAND}-template"
HTTP_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${HTTP_COMMAND}-template"
TRACE_TEMPLATE="${ROOT_DIR}/PROJECT_K/WEB_CHECK_SCRIPT/${TRACE_COMMAND}-template"
